...
//      // 处理小数点
  ...
  ///格式化成万元
  static String formatW(Object valueObj) {
    double d = getDoubleByValueObj(valueObj);
    if (d > 10000) {
      return "${NumberUtil.formatNum(d / 10000, forcePoint: false)}万";
    } else {
      return "${NumberUtil.formatNum(d, forcePoint: false)}元";
    }
  }
}
