...
///    function.
///
/// The [LcfarmSheet] widget itself is rarely used directly. Instead, prefer to
...
///
///
/// 修改了最大高度限制 9 / 16   --->  13 / 16
///
class LcfarmSheet extends StatefulWidget {
  ...
  ///
  ///
  ///     this.enableDrag = false(不能拖动)  ture(可以拖动),
  const LcfarmSheet({
    Key key,
  ...
  @override
  _LcfarmSheetState createState() => _LcfarmSheetState();

  /// Creates an [AnimationController] suitable for a
  /// [LcfarmSheet.animationController].
  ///
...
class _LcfarmSheetState extends State<LcfarmSheet> {
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  AnimationController createAnimationController() {
    ...
    _animationController = LcfarmSheet.createAnimationController(navigator.overlay);
...
/// display the [LcfarmSheet] when set to `true`. This is useful in the case
/// that a modal [LcfarmSheet] needs to be displayed above all other content
...
/// See also:
///
///  * [LcfarmSheet], which becomes the parent of the widget returned by the
